...
|#  |태스크                                |상태  |우선순위|비고         |
|---|-----------------------------------|----|----|-----------|
|1.1|프로젝트 초기화 (TypeScript, pnpm, Docker)|⬜ 대기|🔴 높음|           |
|1.2|PostgreSQL 스키마 생성                  |⬜ 대기|🔴 높음|           |
|1.3|Redis 7+ 연결 설정                     |⬜ 대기|🔴 높음|BullMQ 요구사항|
...
- [ ] @solana/web3.js 버전 확인 (1.95.8+ 필수, 보안 패치)
- [ ] Redis 버전 확인 (7+ 권장, 최소 6.2.0)
- [ ] Node.js 버전 확인 (18+ LTS)
